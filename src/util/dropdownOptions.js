...
export const TM_24_PBR = {
  ...
  specialOrderColors: ['PA', 'TB', 'PB', 'HM', 'PG', 'TC', 'TR', 'CD', 'RR'],
  premiumColors: ['MS', 'CH', 'AP', 'CP', 'WZ'],
};
...
export const MBCI_26_PBR = {
  ...
  specialOrderColors: ['PB', 'MN', 'TU', 'CD', 'MB'],
  premiumColors: [],
};
...
export const MBCI_24_DLOK = {
  ...
  specialOrderColors: ['HW', 'CB', 'ST', 'DS', 'AG', 'IG', 'WR'],
  premiumColors: ['CT'],
};
